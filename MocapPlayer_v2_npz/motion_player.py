...
class MotionPlayer():
    ...
    def load_npz(self, file_name, skel_parents):
        npz_tools_inst = npz.NPZ_Tools()
        mocap_tools_inst = mocap.Mocap_Tools()
        
        # 1. Load the raw OSC dictionary
        osc_data = npz_tools_inst.load(file_name)
        
        # 2. Convert to the standard mocap structure
        mocap_data = mocap_tools_inst.npz_to_mocap(osc_data, skeleton_parents=skel_parents)
